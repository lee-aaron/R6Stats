...
var app = new Vue({
  ...
  data: {
    ...
    profileNameLabel: 'Wargaming Username',
    profile: {
      server: 'na',
      game: 'wot',
      name: ''
  ...
  watch: {
    'profile.server': function (newVal, oldVal) {
      switch (newVal) {
        case 1:
          this.profileNameLabel = 'Gamertag';
          break;
        case 2:
          this.profileNameLabel = 'PSN ID';
          break;
        case 3:
          this.profileNameLabel = 'Steam ID';
          break;
      }
    },
